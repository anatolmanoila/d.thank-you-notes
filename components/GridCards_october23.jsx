  ...
  return (
    <div>
      <ul
        ...
        className="mb-1 flex w-full flex-wrap justify-center gap-12 rounded-xl bg-gradient-to-b from-white to-indigo-100 pt-4 pb-32"
        data-aos="fade-in"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="mb-1 flex w-full flex-wrap justify-center gap-12 rounded-xl bg-gradient-to-b from-teal-100/20 to-white py-24"
        data-aos="fade-up"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="flex w-full flex-wrap justify-center gap-16 rounded-xl bg-gradient-to-r from-teal-100/20 to-teal-500 pt-16 pb-32"
        data-aos="fade-up"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="mt-1 flex w-full flex-wrap items-center justify-center gap-16 rounded-xl bg-gradient-to-b from-teal-500/80 to-white py-16"
        data-aos="fade-up"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
      >
        {signedByDianaOprescu.map((person) => (
          <div
            style={{
              maxWidth: person.maxWidth ? person.maxWidth : '340px',
            }}
