...
const signedByLucian = DPN.september23_signedBy.lucian
const signedBySilvana = DPN.september23_signedBy.silvana
const signedByBianca = DPN.september23_signedBy.bianca
const signedByOthers = DPN.september23_signedBy.others

export default function GridCardsSeptember() {
  return (
    <div>
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className=" flex w-full flex-wrap justify-center gap-8 rounded-xl pt-4 pb-32"
        data-aos="fade-down"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="flex w-full flex-wrap justify-center gap-8 rounded-xl bg-gradient-to-r from-indigo-500/20 to-indigo-100/20 py-24"
        data-aos="fade-up"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="flex w-full flex-wrap justify-center gap-8 py-24"
        data-aos="fade-down"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
      ...
      <ul
        role="list"
        // className="mx-auto grid grid-cols-1 gap-6 bg-sky-500 sm:grid-cols-2 lg:grid-cols-4"
        className="flex w-full flex-wrap justify-center gap-8 rounded-xl bg-gradient-to-r from-teal-100/20 to-teal-500 py-16"
        data-aos="fade-up"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        data-aos-mirror="true"
